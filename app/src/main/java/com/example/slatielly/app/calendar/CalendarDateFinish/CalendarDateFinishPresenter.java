...
public class CalendarDateFinishPresenter implements CalendarDateFinishContract.Presenter, OnSuccessListener<Rent>
{
    ...
    public CalendarDateFinishPresenter (CalendarDateFinishContract.View view, FirestoreRepository<Rent> rentFirestoreRepository){
        this.view = view;
